...
::phf::Map {
    ...
    entries: &[
        ...
        (".html", &["HTML"]),
        (".cls", &["VBA", "Apex", "TeX", "ObjectScript", "OpenEdge ABL"]),
        (".rkt", &["Racket"]),
        (".pm6", &["Raku"]),
        (".oz", &["Oz"]),
        (".mtml", &["MTML"]),
        ...
        (".snippet", &["Vim Snippet"]),
        (".v", &["Coq", "Verilog", "V"]),
        (".fcgi", &["Perl", "PHP", "Lua", "Ruby", "Shell", "Python"]),
        (".krl", &["KRL"]),
        (".cjsx", &["CoffeeScript"]),
        (".plt", &["Gnuplot"]),
        (".yasnippet", &["YASnippet"]),
        ...
        (".wxi", &["XML"]),
        (".asp", &["ASP"]),
        (".inc", &["Pascal", "Pawn", "SQL", "PHP", "Assembly", "C++", "NASL", "Motorola 68K Assembly", "SourcePawn", "POV-Ray SDL", "HTML"]),
        (".podsl", &["Common Lisp"]),
        (".jinja2", &["HTML+Django"]),
        (".gql", &["GraphQL"]),
        (".n", &["Roff", "Nemerle"]),
        ...
        (".arc", &["Arc"]),
        (".matlab", &["MATLAB"]),
        (".sch", &["XML", "Scheme", "Eagle", "KiCad Schematic"]),
        (".rex", &["REXX"]),
        (".pat", &["Max"]),
        ...
        (".nse", &["Lua"]),
        (".xpy", &["Python"]),
        (".m", &["Mathematica", "MATLAB", "MUF", "Limbo", "Mercury", "Objective-C", "M"]),
        (".vh", &["SystemVerilog"]),
        (".workflow", &["XML", "HCL"]),
        (".bdy", &["PLSQL"]),
        (".php5", &["PHP"]),
        ...
        (".js", &["JavaScript+Packer", "JavaScript+URIEncoded", "JavaScript+HexString", "JavaScript+JSFuck", "JavaScript+ObfuscatorIO", "JavaScript"]),
        (".3", &["Roff", "Roff Manpage"]),
        (".rbx", &["Ruby"]),
        (".bsv", &["Bluespec"]),
        (".tcl", &["Tcl"]),
        ...
        (".command", &["Shell"]),
        (".vb", &["Visual Basic .NET"]),
        (".sql", &["SQL", "PLpgSQL", "TSQL", "SQLPL", "PLSQL"]),
        ...
        (".dpatch", &["Darcs Patch"]),
        (".gawk", &["Awk"]),
        (".pro", &["INI", "Prolog", "QMake", "Proguard", "IDL"]),
        ...
        (".l", &["Roff", "PicoLisp", "Common Lisp", "Lex"]),
        (".jsonnet", &["Jsonnet"]),
        (".las", &["Lasso"]),
        (".druby", &["Mirah"]),
        (".c++-objdump", &["Cpp-ObjDump"]),
