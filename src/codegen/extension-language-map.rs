...
::phf::Map {
    ...
    entries: &[
        ...
        (".html", &["HTML"]),
        (".cls", &["OpenEdge ABL", "VBA", "ObjectScript", "TeX", "Apex"]),
        (".rkt", &["Racket"]),
        (".pm6", &["Raku"]),
        (".oz", &["Oz"]),
        (".mtml", &["MTML"]),
        ...
        (".snippet", &["Vim Snippet"]),
        (".v", &["Verilog", "V", "Coq"]),
        (".fcgi", &["PHP", "Shell", "Python", "Ruby", "Perl", "Lua"]),
        (".krl", &["KRL"]),
        (".cjsx", &["CoffeeScript"]),
        (".plt", &["Gnuplot"]),
        (".yasnippet", &["YASnippet"]),
        ...
        (".wxi", &["XML"]),
        (".asp", &["ASP"]),
        (".inc", &["POV-Ray SDL", "SQL", "SourcePawn", "PHP", "HTML", "Pascal", "C++", "NASL", "Pawn", "Assembly", "Motorola 68K Assembly"]),
        (".podsl", &["Common Lisp"]),
        (".jinja2", &["HTML+Django"]),
        (".gql", &["GraphQL"]),
        (".n", &["Nemerle", "Roff"]),
        ...
        (".sig", &["Standard ML"]),
        (".hb", &["Harbour"]),
        (".gml", &["Game Maker Language", "Graph Modeling Language", "Gerber Image", "XML"]),
        (".pkgproj", &["XML"]),
        (".gd", &["GAP", "GDScript"]),
        (".gshader", &["GLSL"]),
        (".zone", &["DNS Zone"]),
        ...
        (".arc", &["Arc"]),
        (".matlab", &["MATLAB"]),
        (".sch", &["KiCad Schematic", "Eagle", "Scheme", "XML"]),
        (".rex", &["REXX"]),
        (".pat", &["Max"]),
        ...
        (".nse", &["Lua"]),
        (".xpy", &["Python"]),
        (".m", &["Mercury", "Limbo", "MUF", "Objective-C", "M", "Mathematica", "MATLAB"]),
        (".vh", &["SystemVerilog"]),
        (".workflow", &["XML", "HCL"]),
        (".bdy", &["PLSQL"]),
        (".php5", &["PHP"]),
        ...
        (".js", &["JavaScript", "JavaScript+JSFuck", "JavaScript+Packer", "JavaScript+URIEncoded", "JavaScript+HexString", "JavaScript+ObfuscatorIO"]),
        (".3", &["Roff", "Roff Manpage"]),
        (".rbx", &["Ruby"]),
        (".bsv", &["Bluespec"]),
        (".tcl", &["Tcl"]),
        ...
        (".command", &["Shell"]),
        (".vb", &["Visual Basic .NET"]),
        (".sql", &["SQL", "SQLPL", "TSQL", "PLpgSQL", "PLSQL"]),
        (".pasm", &["Parrot Assembly"]),
        (".mod", &["Modula-2", "AMPL", "Linux Kernel Module", "XML"]),
        ...
        (".dpatch", &["Darcs Patch"]),
        (".gawk", &["Awk"]),
        (".pro", &["INI", "IDL", "Proguard", "QMake", "Prolog"]),
        (".fs", &["Filterscript", "Forth", "GLSL", "F#"]),
        (".asset", &["Unity3D Asset"]),
        (".tpb", &["PLSQL"]),
        (".fsi", &["F#"]),
        (".hx", &["Haxe"]),
        ...
        (".l", &["PicoLisp", "Common Lisp", "Roff", "Lex"]),
        (".jsonnet", &["Jsonnet"]),
        (".las", &["Lasso"]),
        (".druby", &["Mirah"]),
        (".c++-objdump", &["Cpp-ObjDump"]),
        ...
        (".sass", &["Sass"]),
        (".ins", &["TeX"]),
        (".x", &["Logos", "DirectX 3D File", "Linker Script", "RPC"]),
