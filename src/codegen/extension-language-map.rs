...
::phf::Map {
    ...
    entries: &[
        ...
        (".html", &["HTML"]),
        (".cls", &["ObjectScript", "Apex", "VBA", "OpenEdge ABL", "TeX"]),
        (".rkt", &["Racket"]),
        (".pm6", &["Raku"]),
        (".oz", &["Oz"]),
        (".mtml", &["MTML"]),
        ...
        (".snippet", &["Vim Snippet"]),
        (".v", &["V", "Verilog", "Coq"]),
        (".fcgi", &["Ruby", "Python", "Shell", "PHP", "Lua", "Perl"]),
        (".krl", &["KRL"]),
        (".cjsx", &["CoffeeScript"]),
        (".plt", &["Gnuplot"]),
        (".yasnippet", &["YASnippet"]),
        ...
        (".wxi", &["XML"]),
        (".asp", &["ASP"]),
        (".inc", &["Pascal", "PHP", "NASL", "SQL", "Pawn", "HTML", "SourcePawn", "C++", "Motorola 68K Assembly", "POV-Ray SDL", "Assembly"]),
        (".podsl", &["Common Lisp"]),
        (".jinja2", &["HTML+Django"]),
        (".gql", &["GraphQL"]),
        (".n", &["Nemerle", "Roff"]),
        ...
        (".nse", &["Lua"]),
        (".xpy", &["Python"]),
        (".m", &["Mathematica", "MATLAB", "M", "Limbo", "MUF", "Objective-C", "Mercury"]),
        (".vh", &["SystemVerilog"]),
        (".workflow", &["HCL", "XML"]),
        (".bdy", &["PLSQL"]),
        (".php5", &["PHP"]),
        ...
        (".command", &["Shell"]),
        (".vb", &["Visual Basic .NET"]),
        (".sql", &["TSQL", "SQL", "PLSQL", "SQLPL", "PLpgSQL"]),
        ...
        (".dpatch", &["Darcs Patch"]),
        (".gawk", &["Awk"]),
        (".pro", &["Prolog", "INI", "IDL", "Proguard", "QMake"]),
        ...
        (".l", &["PicoLisp", "Lex", "Common Lisp", "Roff"]),
        (".jsonnet", &["Jsonnet"]),
        (".las", &["Lasso"]),
        (".druby", &["Mirah"]),
        (".c++-objdump", &["Cpp-ObjDump"]),
        ...
        (".sass", &["Sass"]),
        (".ins", &["TeX"]),
        (".x", &["DirectX 3D File", "Logos", "Linker Script", "RPC"]),
