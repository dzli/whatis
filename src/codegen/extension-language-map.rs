...
::phf::Map {
    ...
    entries: &[
        ...
        (".txi", &["Texinfo"]),
        (".geom", &["GLSL"]),
        (".js", &["JavaScript+URIEncoded", "JavaScript+ObfuscatorIO", "JavaScript+Packer", "JavaScript+CharCodeSubtract", "JavaScript", "JavaScript+JSFuck", "JavaScript+LongIdent", "JavaScript+HexString"]),
        (".rexx", &["REXX"]),
        (".gradle", &["Gradle"]),
        (".ado", &["Stata"]),
        (".mdpolicy", &["XML"]),
        ...
        (".epj", &["Ecere Projects"]),
        (".mod", &["Linux Kernel Module", "AMPL", "XML", "Modula-2"]),
        (".cu", &["Cuda"]),
        (".njs", &["JavaScript"]),
        ...
        (".gml", &["Graph Modeling Language", "XML", "Game Maker Language", "Gerber Image"]),
        ...
        (".urs", &["UrWeb"]),
        (".sch", &["Eagle", "Scheme", "XML", "KiCad Schematic"]),
        (".xaml", &["XML"]),
        (".sagews", &["Sage"]),
        (".axml", &["XML"]),
        (".psc1", &["XML"]),
        ...
        (".no", &["Text"]),
        (".tsx", &["XML", "TSX"]),
        (".cls", &["TeX", "VBA", "OpenEdge ABL", "ObjectScript", "Apex"]),
        (".ccproj", &["XML"]),
        (".bsv", &["Bluespec"]),
        (".ninja", &["Ninja"]),
        (".xmi", &["XML"]),
        ...
        (".vhi", &["VHDL"]),
        (".jake", &["JavaScript"]),
        (".fcgi", &["Python", "Ruby", "Lua", "Perl", "PHP", "Shell"]),
        (".arc", &["Arc"]),
        (".udo", &["Csound"]),
        (".sql", &["SQL", "SQLPL", "PLSQL", "TSQL", "PLpgSQL"]),
        (".sexp", &["Common Lisp"]),
        (".pro", &["Prolog", "IDL", "QMake", "Proguard", "INI"]),
        (".ui", &["XML"]),
        (".apib", &["API Blueprint"]),
        (".xqm", &["XQuery"]),
        (".wisp", &["wisp"]),
        ...
        (".cson", &["CSON"]),
        (".ash", &["AGS Script"]),
        (".vba", &["Vim script", "VBA", "VBA+JSONPacked"]),
        (".golo", &["Golo"]),
        (".gnu", &["Gnuplot"]),
        (".rbuistate", &["REALbasic"]),
        (".dcl", &["Clean"]),
        (".pluginspec", &["Ruby", "XML"]),
        (".inc", &["SQL", "NASL", "Assembly", "HTML", "PHP", "SourcePawn", "C++", "Pawn", "Motorola 68K Assembly", "POV-Ray SDL", "Pascal"]),
        (".yar", &["YARA"]),
        ...
        (".asd", &["Common Lisp"]),
        (".c++-objdump", &["Cpp-ObjDump"]),
        (".m", &["Limbo", "MUF", "Mathematica", "M", "Objective-C", "Mercury", "MATLAB"]),
        (".rhtml", &["RHTML"]),
        (".dot", &["Graphviz (DOT)"]),
        (".rsc", &["Rascal"]),
        (".fr", &["Text", "Frege", "Forth"]),
