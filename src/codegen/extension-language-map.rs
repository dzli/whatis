...
::phf::Map {
    ...
    entries: &[
        ...
        (".syntax", &["YAML"]),
        (".arpa", &["DNS Zone"]),
        (".inc", &["SourcePawn", "POV-Ray SDL", "PHP", "HTML", "C++", "Pawn", "NASL", "Pascal", "SQL", "Assembly", "Motorola 68K Assembly"]),
        (".hql", &["HiveQL"]),
        (".asmx", &["ASP"]),
        (".gn", &["GN"]),
        ...
        (".pro", &["IDL", "QMake", "Proguard", "Prolog", "INI"]),
        (".nimrod", &["Nim"]),
        (".dpatch", &["Darcs Patch"]),
        (".rabl", &["Ruby"]),
        (".moo", &["Moocode", "Mercury"]),
        ...
        (".sl", &["Slash"]),
        (".l", &["PicoLisp", "Roff", "Lex", "Common Lisp"]),
        (".duby", &["Mirah"]),
        (".nasm", &["Assembly"]),
        (".shen", &["Shen"]),
        (".krl", &["KRL"]),
        ...
        (".ronn", &["Markdown"]),
        (".jake", &["JavaScript"]),
        (".fcgi", &["Python", "Ruby", "PHP", "Perl", "Lua", "Shell"]),
        (".arc", &["Arc"]),
        (".udo", &["Csound"]),
        (".csl", &["XML"]),
        (".sexp", &["Common Lisp"]),
        ...
        (".m", &["Mathematica", "Mercury", "Limbo", "M", "Objective-C", "MUF", "MATLAB"]),
        (".nuspec", &["XML"]),
        (".bibtex", &["BibTeX"]),
        (".8xp.txt", &["TI Program"]),
        (".sbt", &["Scala"]),
        ...
        (".sed", &["sed"]),
        (".cabal", &["Cabal Config"]),
        (".sch", &["XML", "KiCad Schematic", "Eagle", "Scheme"]),
        (".d", &["DTrace", "Makefile", "D"]),
        (".adp", &["Tcl"]),
        (".xrl", &["Erlang"]),
        (".cfc", &["ColdFusion CFC"]),
        ...
        (".h++", &["C++"]),
        (".m4", &["M4Sugar", "M4"]),
        (".sql", &["PLSQL", "PLpgSQL", "SQLPL", "SQL", "TSQL"]),
        (".nasl", &["NASL"]),
        (".scm", &["Scheme"]),
        (".pony", &["Pony"]),
        (".scala", &["Scala"]),
