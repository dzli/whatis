...
::phf::Map {
    ...
    entries: &[
        ...
        (".syntax", &["YAML"]),
        (".arpa", &["DNS Zone"]),
        (".inc", &["SQL", "NASL", "Assembly", "Motorola 68K Assembly", "PHP", "Pawn", "SourcePawn", "Pascal", "POV-Ray SDL", "C++", "HTML"]),
        (".hql", &["HiveQL"]),
        (".asmx", &["ASP"]),
        (".gn", &["GN"]),
        ...
        (".pro", &["INI", "QMake", "Prolog", "Proguard", "IDL"]),
        (".nimrod", &["Nim"]),
        (".dpatch", &["Darcs Patch"]),
        (".rabl", &["Ruby"]),
        (".moo", &["Mercury", "Moocode"]),
        ...
        (".tese", &["GLSL"]),
        (".rs.in", &["Rust"]),
        (".gml", &["Gerber Image", "Game Maker Language", "Graph Modeling Language", "XML"]),
        ...
        (".rktl", &["Racket"]),
        (".ol", &["Jolie"]),
        (".cls", &["VBA", "Apex", "OpenEdge ABL", "ObjectScript", "TeX"]),
        (".pod6", &["Pod 6"]),
        (".gms", &["GAMS"]),
        ...
        (".sl", &["Slash"]),
        (".l", &["Roff", "Common Lisp", "Lex", "PicoLisp"]),
        (".duby", &["Mirah"]),
        (".nasm", &["Assembly"]),
        (".shen", &["Shen"]),
        (".krl", &["KRL"]),
        ...
        (".ronn", &["Markdown"]),
        (".jake", &["JavaScript"]),
        (".fcgi", &["Lua", "Ruby", "Python", "Perl", "PHP", "Shell"]),
        (".arc", &["Arc"]),
        (".udo", &["Csound"]),
        (".csl", &["XML"]),
        (".sexp", &["Common Lisp"]),
        ...
        (".m", &["Limbo", "Mathematica", "Mercury", "MATLAB", "Objective-C", "M", "MUF"]),
        (".nuspec", &["XML"]),
        (".bibtex", &["BibTeX"]),
        (".8xp.txt", &["TI Program"]),
        (".sbt", &["Scala"]),
        ...
        (".kid", &["Genshi"]),
        (".prefs", &["INI"]),
        (".mod", &["AMPL", "XML", "Linux Kernel Module", "Modula-2"]),
        (".gemspec", &["Ruby"]),
        (".psgi", &["Perl"]),
        (".tst", &["GAP", "Scilab"]),
        (".xojo_toolbar", &["Xojo"]),
        ...
        (".h++", &["C++"]),
        (".m4", &["M4", "M4Sugar"]),
        (".sql", &["SQL", "TSQL", "SQLPL", "PLSQL", "PLpgSQL"]),
        (".nasl", &["NASL"]),
        (".scm", &["Scheme"]),
        (".pony", &["Pony"]),
        (".scala", &["Scala"]),
